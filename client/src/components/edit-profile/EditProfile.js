...
const CreateProfile = () => {
  ...
  useEffect(() => {
    ...
    if (!isEmpty(Prof)) {
      ...
      Profile.company = !isEmpty(Prof.company) ? Prof.company : "";
      Profile.website = !isEmpty(Prof.website) ? Prof.website : "";
      Profile.location = !isEmpty(Prof.location) ? Prof.location : "";
      Profile.githubusername = !isEmpty(Prof.githubusername)
        ? Prof.githubusername
        : "";
